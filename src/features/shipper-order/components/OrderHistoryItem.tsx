...
export default function OrderHistoryItem({ data }: OrderShipperItemProps) {
   ...
   <Card style={styles.container}>
         <View style={styles.orderHeaderContainer}>
           <Text style={styles.orderCode}>#{data.code}</Text>
             <Tag variant='success'>
               <Text style={{ color: '#ffffff', fontWeight: 600 }}>{data.deliveryStatus === 'Completed' ? 'Hoàn thành' : 'Chưa hoàn thành'}</Text>
             </Tag>
         </View>
